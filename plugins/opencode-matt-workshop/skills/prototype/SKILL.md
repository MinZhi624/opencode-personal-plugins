...
Maker may build the throwaway code but never changes Git state. Foreman owns any branch, commit, or captured context pointer required after the prototype returns.
