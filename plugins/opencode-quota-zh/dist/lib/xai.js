...
export async function resolveXaiAuthIdentity() {
...
function parseCreditsWindow(payload, observedAtMs) {
    ...
    const fixedWindow = Number.isFinite(startedAtMs) && startedAtMs < observedAtMs && observedAtMs < endsAtMs
        ? {
            kind: "fixed_window",
