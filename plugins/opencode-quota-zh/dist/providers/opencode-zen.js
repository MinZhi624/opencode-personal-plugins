...
const OPENCODE_ZEN_STATUS_ACCOUNTING = {
    resultType: "status",
    acquisitionMethod: "dashboard_scrape",
    ownership: "maintained",
    authority: "provider_reported",
...
export const opencodeZenProvider = {
    ...
    async fetch(ctx) {
        ...
        const hasMonthlyBudget = effectiveMonthlyLimit !== null &&
            ...
            entries.push({
                ...
                basis: {
                    ...
                    limit: {
                        ...
                        authority: configuredMonthlyLimit === undefined ? "provider_reported" : "user_configured",
                    },
                    remaining: {
        ...
        return withStatusDetails(attemptedResult(entries), [
            ...
            { key: "balance_usd", value: `USD ${zenUsdDecimal(balanceUsd)}` },
            {
                ...
                value: result.data.monthlyLimit === null
                    ? "(none)"
                    : `USD ${zenUsdDecimal(result.data.monthlyLimit)}`,
            },
            {
                key: "last_payment_usd",
                value: result.data.lastPayment === null
                    ? "(none)"
