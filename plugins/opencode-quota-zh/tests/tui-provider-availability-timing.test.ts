...
// Chinese fork adaptation: the compact status counts provider issues in
// Chinese units ("+1 个问题") instead of the upstream English "+1 issue".
const COMPACT_TEXT = "Cursor timing 80% | Qwen timing 60% | +1 个问题";
